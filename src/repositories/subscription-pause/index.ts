...
export class SubscriptionPauseRepository {
  findManyByBusinessId(businessId: string, customerId?: string): Promise<SubscriptionPauseRecord[]> {
    return subscriptionPausePersistentStorageRepository.findManyByBusinessId(businessId, customerId);
  }

  findSubscription(businessId: string, subscriptionId: string): Promise<PauseSubscriptionRecord | null> {
    return subscriptionPausePersistentStorageRepository.findSubscription(businessId, subscriptionId);
  }
